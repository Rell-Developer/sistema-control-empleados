        ...
        <div class="p-3 border rounded-b">
            ...
            <div class="w-full flex flex-col">
                ...
                <div class="flex flex-col w-full mb-2">  
                    ...
                    <input type="text" name="usuario" class="w-full border py-1 rounded my-1">
                </div>

                <div class="flex flex-col w-full mb-2">  
                    <label for="password">Contraseña:</label>
                    <input type="password" name="password" class="w-full border py-1 rounded my-1">
                </div>

                <div class="flex flex-col w-full mb-2">  
                    <label for="email">Correo:</label>
                    <input type="email" name="email" class="w-full border py-1 rounded my-1">
                </div>
            </div>
