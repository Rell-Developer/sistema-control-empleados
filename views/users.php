                ...
                <table class="w-full mx-auto">
                    <thead class="w-full">
                        <tr class="w-full border-b">
                            ...
                            <td class="font-bold py-1">Nombre de Usuario</td>
                            <td class="font-bold py-1">Contraseña</td>
                            <td class="font-bold py-1">Correo</td>
